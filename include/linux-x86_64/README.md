# fractalsql-core 2.0.18 — Community Edition (linux-x86_64-glibc-2.34)

This tarball ships the FractalSQL Core Community Edition libraries
for linux-x86_64-glibc-2.34, built and validated by the foundry's CI on the v2.0.18
release tag.
...
```bash
cd fractalsql-core-2.0.18-community-linux-x86_64-glibc-2.34/
