# fractalsql-core 2.0.18 — Community Edition (darwin-arm64)

This tarball ships the FractalSQL Core Community Edition libraries
for darwin-arm64, built and validated by the foundry's CI on the v2.0.18
release tag.
...
```bash
cd fractalsql-core-2.0.18-community-darwin-arm64/
