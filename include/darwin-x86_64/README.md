# fractalsql-core 2.0.18 — Community Edition (darwin-x86_64)

This tarball ships the FractalSQL Core Community Edition libraries
for darwin-x86_64, built and validated by the foundry's CI on the v2.0.18
release tag.
...
```bash
cd fractalsql-core-2.0.18-community-darwin-x86_64/
