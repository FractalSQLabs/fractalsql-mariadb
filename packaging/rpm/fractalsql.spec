...
# stable across MariaDB 10.6/10.11/11.4 LTS/12.2 rolling) is the
...
Version:        2.0.0
Release:        1%{?dist}
Summary:        Stochastic Fractal Search UDF for MariaDB (10.6 / 10.11 / 11.4 LTS / 12.2 rolling)
...
- Full v2.0.0 port: Discovery/Vector/Cognition/Text-to-SQL/Vectorizer/
  ...
  per-major split -- the UDF ABI is stable across the whole 10.6-12.2
